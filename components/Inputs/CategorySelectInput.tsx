...
export const CategorySelectInput: FC<CategorySelectInputProps> = ({
  options,
  selected,
  handleChange,
}) => {
    ...
    <div className="">
      <Listbox value={selected} onChange={handleChange}>
        <div className="relative mt-1">
          <Listbox.Button className="relative w-full flex px-4 border border-gray-300 text-slate-700 text-sm py-2 rounded-md">
